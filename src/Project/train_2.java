...
public class train_2 { //Hyd-Chennai
	static int i1;
	int ticket=0;  int seats=10; int temp2=0; int rebook; int temp=ticket; int option;  int reticket; int price=250;
	String name; long phone_num; short age; String Emailid; int count;
	train_2(Train_main tr) {
		int i1=tr.select; 
