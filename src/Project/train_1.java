...
public class train_1 {//hyd-vizag
	static int i1;
	int ticket=0;  int seats=5; int temp2=0; int rebook; int temp=ticket; int option;  int reticket; int price=150;
	String name; long phone_num; short age; String Emailid; int count;
	
	train_1(Train_main tr) {
		int i1=tr.select; 
	...
	{
		/*train_main tr=new train_main();
		tr.display();
	train_1 t1=new train_1();
	t1.display();*/
	}
}
